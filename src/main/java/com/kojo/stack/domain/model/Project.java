...
public class Project implements Serializable {
    ...
    public enum ProjectType {
       ARCHITECTURE, MICROSERVICES, DEVOPS, BACKEND_SERVICE, FRONTEND, FULL_STACK, DATA_ENGINEERING, CONSULTING, MIGRATION, ETL, MONITORING, CODE_REVIEW, MENTORING, TRANSFORMATION
    }
